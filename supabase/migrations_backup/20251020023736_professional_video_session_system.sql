...
-- Step 5: Create session_recordings table
...
-- Step 12: Trigger for mechanic_availability.updated_at
...
-- Step 13: Helper to get session duration by plan
...
-- Step 14: Backfill duration_minutes
