  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 px-4 py-16 text-white">
      <div className="mx-auto flex max-w-4xl flex-col gap-8">
        <Link href="/dashboard" className="inline-flex items-center gap-2 text-sm text-blue-200 hover:text-white">
          <ArrowLeft className="h-4 w-4" /> Back to dashboard
        </Link>

        <header className="rounded-3xl border border-slate-700 bg-slate-900/80 p-8 shadow-xl">
          <div className="flex flex-col gap-4 text-center">
            <span className="mx-auto inline-flex items-center gap-2 rounded-full bg-blue-500/20 px-4 py-1 text-xs font-semibold uppercase tracking-wider text-blue-100">
        ...
        <section className="grid gap-4 rounded-3xl border border-slate-700 bg-slate-900/80 p-8 shadow-xl md:grid-cols-2">
          ...
          <div className="space-y-4 rounded-2xl bg-slate-800/60 p-5">
            <h3 className="text-sm font-semibold text-blue-200">Session files</h3>
            <button className="flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-lg transition hover:bg-blue-700">
              <Download className="h-4 w-4" />
              Download all attachments
            </button>
            <Link href="/session/new" className="block rounded-xl border border-blue-300/40 px-4 py-3 text-center text-sm font-semibold text-blue-100 transition hover:border-blue-200 hover:text-white">
