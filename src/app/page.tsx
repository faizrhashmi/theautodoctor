      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-tight tracking-tight">
                    Expert Auto
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 block bg-[length:200%_200%] animate-gradient">
                      Mechanics
                    </span>
            ...
            <div className="lg:w-1/2 flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <div className="absolute -top-6 -right-6 w-28 h-28 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-3xl rotate-12 opacity-20 animate-bounce shadow-2xl"></div>
                <div className="absolute -bottom-8 -left-8 w-36 h-36 bg-gradient-to-br from-cyan-400 to-blue-400 rounded-4xl -rotate-12 opacity-15 animate-bounce shadow-2xl" style={{animationDelay: '2s'}}></div>
        ...
        <div className="absolute bottom-0 left-0 right-0 transform translate-y-1">
          <svg className="w-full h-20 text-white" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" fill="currentColor" opacity="0.25"></path>
