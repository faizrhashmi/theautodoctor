...
export default function HowItWorksPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      <header className="bg-blue-950/40">
        <div className="mx-auto max-w-5xl px-4 py-20 sm:px-6 lg:px-8">
          <span className="rounded-full bg-blue-500/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-blue-200">
            How it works
          </span>
      ...
      <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <section className="mt-16 rounded-3xl border border-white/10 bg-gradient-to-br from-blue-900/70 to-slate-900/70 p-8 backdrop-blur">
          ...
          <div className="mt-6 flex flex-col gap-4 sm:flex-row">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full border border-blue-200/60 px-6 py-3 text-sm font-semibold text-blue-100 transition hover:border-blue-100 hover:text-white"
            >
              View mechanic tools
              <ArrowRight className="h-4 w-4" />
            </Link>
