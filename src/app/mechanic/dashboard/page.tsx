          ...
          <div className="mb-6 sm:mb-8 bg-blue-500/10 backdrop-blur-sm border border-blue-500/30 rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              {pendingRequests.map((request) => (
                <div
                  key={request.id}
                  className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 rounded-lg border border-blue-500/30 bg-slate-900/50 hover:border-blue-500/50 transition-all gap-4"
                >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm text-slate-400">
                        ...
                        {request.intake?.concern && (
                          <>
                            <span className="text-slate-600">•</span>
                            <span className="truncate max-w-xs">{request.intake.concern.substring(0, 50)}...</span>
                          </>
                        )}
                      </div>
                    </div>
