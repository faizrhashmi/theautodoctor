    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <section className="border-b border-slate-800">
        <div className="mx-auto max-w-5xl px-6 py-16">
          <p className="inline-flex items-center gap-2 rounded-full bg-orange-500/10 border border-orange-500/20 px-3 py-1 text-xs uppercase tracking-[0.2em] text-orange-400">
            <Headset className="h-3.5 w-3.5" />
            Support Team
          </p>
          <h1 className="mt-4 text-3xl font-semibold sm:text-4xl text-white">Contact Us</h1>
      ...
      <section className="mx-auto grid max-w-5xl gap-10 px-6 py-12 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-3xl border border-slate-700 bg-slate-800/50 backdrop-blur-sm p-6 shadow-xl sm:p-8">
        ...
        <aside className="space-y-6">
          <div className="rounded-3xl border border-orange-500/20 bg-orange-500/5 backdrop-blur-sm p-6 text-sm">
            <h3 className="inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.25em] text-orange-400">
          ...
          <div className="rounded-3xl border border-slate-700 bg-slate-800/50 backdrop-blur-sm p-6 text-sm shadow-xl">
            <h3 className="inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.25em] text-slate-400">
            ...
            <div className="mt-4 space-y-3 text-slate-300">
              <p>
                Email us at
                <a href="mailto:support@theautodoctor.com" className="ml-1 font-medium text-orange-400 hover:text-orange-300 transition-colors">
            ...
            <div className="mt-6 rounded-2xl bg-slate-900/50 border border-slate-700 p-4 text-xs text-slate-400">
