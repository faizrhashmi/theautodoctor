        ...
        <div className="mt-8 space-y-6 rounded-2xl bg-white p-8 shadow-sm">
          <div className="rounded-lg bg-blue-50 p-4">
            <div className="flex items-start gap-3">
              <svg className="h-6 w-6 flex-shrink-0 text-orange-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="mt-3 text-sm text-slate-600">
              ...
              <a href="mailto:support@askautodoctor.com" className="font-semibold text-orange-600 hover:text-blue-700">
                Contact Support
              </a>
            </p>
          </div>
