...
export default function CustomerDashboardPage() {
  ...
  return (
    <div className="min-h-screen py-4 sm:py-6 lg:py-8 pt-20 lg:pt-8">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        {/* Header with Actions */}
        <div className="mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-white">Dashboard</h1>
            <p className="text-slate-400 mt-1">Enterprise command center for your vehicle services</p>
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <Link
              ...
              className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 border border-blue-500/30 rounded-lg p-4 hover:border-blue-400 hover:shadow-lg hover:shadow-blue-500/20 transition-all group"
            >
              ...
              <div className="text-xs text-slate-400 mt-1">Book appointment</div>
            </Link>

            <Link
              href="/customer/quotes"
              className="bg-gradient-to-br from-amber-500/10 to-amber-600/5 border border-amber-500/30 rounded-lg p-4 hover:border-amber-400 hover:shadow-lg hover:shadow-amber-500/20 transition-all group"
            >
              <FileText className="w-8 h-8 text-amber-400 mb-3 group-hover:scale-110 transition-transform" />
              <div className="text-sm font-medium text-white">Quotes</div>
              <div className="text-xs text-slate-400 mt-1">View estimates</div>
            </Link>

            <Link
              href="/customer/vehicles"
              className="bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/30 rounded-lg p-4 hover:border-purple-400 hover:shadow-lg hover:shadow-purple-500/20 transition-all group"
            >
              ...
              <div className="text-xs text-slate-400 mt-1">Manage fleet</div>
            </Link>

            <Link
              href="/customer/sessions"
              className="bg-gradient-to-br from-green-500/10 to-green-600/5 border border-green-500/30 rounded-lg p-4 hover:border-green-400 hover:shadow-lg hover:shadow-green-500/20 transition-all group"
            >
              <Clock className="w-8 h-8 text-green-400 mb-3 group-hover:scale-110 transition-transform" />
              <div className="text-sm font-medium text-white">History</div>
              <div className="text-xs text-slate-400 mt-1">Past sessions</div>
            </Link>

            <Link
              href="/customer/profile"
              className="bg-gradient-to-br from-orange-500/10 to-orange-600/5 border border-orange-500/30 rounded-lg p-4 hover:border-orange-400 hover:shadow-lg hover:shadow-orange-500/20 transition-all group"
            >
              <User className="w-8 h-8 text-orange-400 mb-3 group-hover:scale-110 transition-transform" />
              <div className="text-sm font-medium text-white">Profile</div>
              <div className="text-xs text-slate-400 mt-1">Your account</div>
            </Link>

            <Link
              href="/customer/messages"
              className="bg-gradient-to-br from-pink-500/10 to-pink-600/5 border border-pink-500/30 rounded-lg p-4 hover:border-pink-400 hover:shadow-lg hover:shadow-pink-500/20 transition-all group"
            >
              <MessageSquare className="w-8 h-8 text-pink-400 mb-3 group-hover:scale-110 transition-transform" />
              <div className="text-sm font-medium text-white">Messages</div>
              <div className="text-xs text-slate-400 mt-1">Communicate</div>
            </Link>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link
              href="/customer/sessions"
              className="bg-gradient-to-br from-slate-800/50 to-slate-800/30 backdrop-blur-sm rounded-lg border border-slate-700 p-6 hover:border-orange-500/50 hover:shadow-lg hover:shadow-orange-500/10 transition-all group cursor-pointer"
            >
              ...
              <div className="text-3xl font-bold text-white mb-2">{stats?.total_services || 0}</div>
            ...
            >
              ...
              <div className="text-3xl font-bold text-white mb-2">${(stats?.total_spent || 0).toFixed(2)}</div>
              <div className="flex items-center justify-between">
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm text-slate-400">Active Warranties</div>
                </div>
                <Check className="w-4 h-4 text-purple-400" />
              </div>
              <div className="text-3xl font-bold text-white mb-2">{stats?.active_warranties || 0}</div>
              <div className="flex items-center justify-between">
                <div className="text-xs text-slate-500">
            ...
            >
              ...
              <div className="text-3xl font-bold text-white mb-2">{stats?.pending_quotes || 0}</div>
              <div className="flex items-center justify-between">
                <div className="text-xs text-slate-500">
                  {stats?.pending_quotes && stats.pending_quotes > 0
        ...
        {recentSessions.length > 0 ? (
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg border border-slate-700 p-6">
            ...
            <div className="space-y-3">
              {recentSessions.map((session) => (
                <div
                  key={session.id}
                  className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-slate-900/50 rounded-lg border border-slate-700 hover:border-orange-500/50 transition-all group gap-3"
                >
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <span className="text-sm font-medium text-white">{session.mechanic_name}</span>
                  ...
                  <div className="flex items-center gap-4 ml-12 sm:ml-0">
                    <div className="text-right">
                      <p className="text-lg font-bold text-white">${session.price.toFixed(2)}</p>
                    </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg border border-slate-700 p-8 text-center">
            ...
            <p className="text-sm text-slate-500 mt-2">Select a plan above and start your first session to see your history here</p>
          </div>
        )}
      </div>
    </div>
