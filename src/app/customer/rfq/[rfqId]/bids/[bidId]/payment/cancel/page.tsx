...
/**
 * RFQ Bid Payment Cancel Page
 * Phase 1.4: Shows when customer cancels payment at Stripe checkout
 */
export default function RfqBidPaymentCancelPage() {
  ...
  const handleRetryPayment = async () => {
    ...
    try {
      ...
      const response = await fetch(apiRouteFor.rfqBidPaymentCheckout(rfqId, bidId), {
        method: 'POST',
      ...
      console.error('[bid-payment-cancel] Error retrying payment:', error)
      setRetrying(false)
          ...
          <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-6 text-left">
            ...
            <div className="space-y-3 text-sm text-slate-300">
              ...
              <div className="flex items-start gap-3">
                ...
                <p>
                  <strong className="text-white">Review Other Bids</strong>
                  <br />
                  Go back to compare other workshop bids for your repair
                </p>
              </div>
            </div>
          </div>
