...
export default function MechanicApplicationsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Mechanic Applications</h1>
        <p className="mt-1 text-sm text-slate-600">Review and approve mechanic applications</p>
      </div>
      ...
      <div className="flex gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-300 bg-white py-2 pl-10 pr-4 text-sm focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500/20"
          />
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-12 text-center">
          ...
          <p className="mt-4 text-sm font-medium text-slate-900">No applications found</p>
        ...
        <div className="flex-1">
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-600">{application.years_of_experience} years exp</span>
            </div>
            {application.red_seal_certified && (
              <div className="flex items-center gap-2">
                <CheckCircle2 className="h-4 w-4 text-green-500" />
                <span className="text-slate-600">Red Seal Certified</span>
              </div>
            )}
            <div className="flex items-center gap-2">
              <Building2 className="h-4 w-4 text-slate-400" />
              <span className="text-slate-600 capitalize">{application.shop_affiliation}</span>
            </div>
            {application.liability_insurance && (
              <div className="flex items-center gap-2">
                <Shield className="h-4 w-4 text-blue-500" />
                <span className="text-slate-600">Insured</span>
              </div>
            )}
          </div>
        ...
        <div className="p-6 space-y-6">
          ...
          application.application_status === 'under_review' ? (
            <div className="rounded-lg border border-slate-200 bg-slate-50 p-6">
              ...
              <p className="mt-1 text-sm text-slate-600">Review the application and take action</p>
              ...
              <div className="mt-4 space-y-4">
                <textarea
                  ...
                  className="w-full rounded-lg border border-slate-300 p-3 text-sm focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500/20"
                  rows={3}
                />
...
function DocumentLink({ label, url }: { label: string; url: string }) {
  return (
    <a
      ...
      className="flex items-center justify-between rounded-lg border border-slate-200 bg-white p-3 text-sm transition hover:border-orange-500 hover:bg-orange-50"
    >
