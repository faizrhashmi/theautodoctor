      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-12 px-6 py-24 sm:px-8 lg:px-12">
        ...
        <div className="max-w-4xl space-y-10">
          <div className="relative max-w-lg">
            ...
            <div className="relative overflow-visible rounded-2xl border border-orange-500/50 bg-gradient-to-br from-orange-500/15 to-red-600/15 p-5 backdrop-blur-md">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="space-y-1">
                  <p className="text-2xl font-bold text-white">FREE Trial Session</p>
                  <p className="text-xs font-medium uppercase tracking-[0.25em] text-orange-200/80">Limited slots this month</p>
                  <p className="text-sm text-orange-100/80">Get expert help at zero cost while it lasts.</p>
                </div>
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-orange-500 to-red-600 shadow-lg shadow-orange-500/50">
