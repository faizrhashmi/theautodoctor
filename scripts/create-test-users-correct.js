...
async function createTestUsers() {
  console.log('🚀 Creating Phase 1 Test Users (Correct Schema)...\n');
  ...
  try {
    ...
    // Step 3: Create mechanics with correct schema
    ...
    const mechanics = [
      {
        ...
        service_tier: 'virtual', // Using 'virtual' which should be valid
        account_type: null, // CRITICAL: Virtual-only = NULL
      ...
      },
      {
        ...
        account_type: 'employee', // CRITICAL: Workshop employee
      ...
      },
      {
        ...
        service_tier: 'virtual',
        account_type: 'owner', // CRITICAL: Independent owner
        workshop_id: '00000000-0000-0000-0000-000000000011', // CRITICAL: Their own workshop
        application_status: 'approved',
        is_available: true,
        can_accept_sessions: true
      }
    ...
    for (const mechanic of mechanics) {
      ...
      if (error) {
        ...
        const type = !mechanic.workshop_id ? 'VIRTUAL_ONLY ✅' :
                     mechanic.account_type === 'employee' ? 'WORKSHOP_EMPLOYEE ❌' :
                     mechanic.account_type === 'owner' ? 'INDEPENDENT_WORKSHOP ✅' :
                     'UNKNOWN';
    ...
    console.log('   Type: account_type=NULL, workshop_id=NULL');
    ...
    console.log('   Type: account_type=employee, workshop_id=SET');
    ...
    console.log('   Type: account_type=owner, workshop_id=SET');
    console.log('   Access: ✅ CAN access Earnings & Analytics\n');
