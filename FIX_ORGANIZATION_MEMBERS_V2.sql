...
BEGIN
  ...
  IF is_org_owner_exists THEN
    RAISE NOTICE '✅ is_org_owner_or_admin() function exists';
  ELSE
    RAISE WARNING '❌ is_org_owner_or_admin() function not found';
  END IF;
  ...
  RAISE NOTICE '============================================';
  RAISE NOTICE '✅ organization_members V2 fix complete!';
  RAISE NOTICE '✅ 100% recursion-proof - no direct table queries';
  RAISE NOTICE '============================================';
END $$;
